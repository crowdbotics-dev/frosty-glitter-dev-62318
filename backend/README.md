...
## Project Structure
    ...
    ├── frosty_glitter_dev_62318  # Django project configurations
...
1. Clone this repo and `cd frosty_glitter_dev_62318`
...
2. Clone this repo and `cd frosty_glitter_dev_62318`
