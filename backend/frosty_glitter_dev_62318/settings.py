"""
Django settings for frosty_glitter_dev_62318 project.
...
ROOT_URLCONF = 'frosty_glitter_dev_62318.urls'
...
WSGI_APPLICATION = 'frosty_glitter_dev_62318.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_glitter_dev_62318 API",
    "DESCRIPTION": "API documentation for frosty_glitter_dev_62318 App",
    "VERSION": "v1",
}
